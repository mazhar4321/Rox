...
function FaqsContent() {
  ...
  return (
    <AnimatedSection className='z-30 flex justify-end w-full flex-col justify-end items-end'>
    ...
    <div className='border-1 faqs-content border-[#86358a]  rounded-md lg:w-1/2 w-full py-5 border z-30 bg-[#2b2c3e] overflow-y-scroll h-[70vh]'>
      ...
      <div className=' py-2 border-b  border-[#86358a]'>
      ...
      <div className=' py-4 border-t border-b  border-[#86358a]'>
