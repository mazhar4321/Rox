    ...
    <div className='relative h-screen'>
      ...
      <div className='container mx-auto '>
        <div className=' z-10 h-screen relative justify-between flex flex-col lg:flex-row'>
          <div className='  z-10 absolute lg:-bottom-10   lg:left-0 w-full  z-10'>
            <img className='  max-h-full 2xl:h-[90vh] w-fit lg:h-[90vh]' src={slide2} alt='' />
          ...
          <div className='w-full h-full float-right lg:py-20 py-10 uppercase text-white flex flex-col justify-end items-center lg:justify-center gap-1 lg:gap-5 lg:items-end '>
            <h1 className='xl:text-xl 2xl:text-4xl text-white text-end font-[TacticSans-bold] text-xl z-10 2xl:text-6xl'>Why Rox?</h1>
            <div className='z-10'>
            ...
            <div className='font-[TacticSans-bold]  text-xs text-end z-10 flex items-end justify-end'>
              <p className='xl:text-xs lg:w-1/2 w-full text-[10px] text-center lg:text-end 2xl:text-xl lg:text-base'>ROX is a subscription-based digital lifestyle brand that
                lets you enjoy the best of both worlds. We’re the digital
                essentials toolkit you need to enjoy the real
                online experience.</p>
            </div>
            <div className=' z-20'>
              <h3 className='text-center download-rox  items-center 2xl:text-4xl lg:text-xl font-[TacticSans-bold] green-stroke lg:mr-10 mr-0'>DOWNLOAD & ROX NOW</h3>
            </div>
            <div className='flex gap-5 z-10'>
              <img className='h-8 lg:h-12 2xl:h-24' src={AppStore} alt='' />
              <img className='h-8 lg:h-12 2xl:h-24' src={GooglePlay} alt='' />
            </div>
          </div>
        </div>
      </div>
