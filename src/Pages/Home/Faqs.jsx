...
function Faqs() {
  return (
    ...
    <div className='absolute -right-300  w-full h-full z-10 shade'>
    <img className='w-full h-full' src={PurpleGradient} alt=''/>
    </div>
   <BgImageAnimation/>
    <img src={RoundedIcon} className='absolute lg:bottom-0 lg:top-20 top-40 right-1/2 z-20 lg:w-[7vw] w-12' alt='' />
    ...
    <img src={Slide2} className='absolute lg:top-10 top-20 left-0 rotate-[65deg] z-20 lg:w-[7vw] w-12' alt='' />
    </div>
