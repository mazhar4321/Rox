...
function ApplyNow() {
  ...
  return (
    ...
    <div className='flex lg:flex-col flex-row gap-5 w-full justify-center'>
      <img src={Apply} className='lg:h-fit lg:w-[70%] w-fit h-8' alt='' />
      <img src={Now}  className='lg:h-fit h-8 lg:w-[50%] w-fit lg:mt-2 mt-0' alt='' />
      </div>
      </div>
      <div className='lg:w-3/6 w-full flex flex-col lg:justify-center justify-end items-center mx-auto relative max-h-full form'>
